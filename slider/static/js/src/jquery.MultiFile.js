...
if (window.jQuery)(function ($) {
			...
			.each(function () {
				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					//$.each(files, function (i, file) {
						...
						var
							r = $('<div class="MultiFile-label" style="background: yellowgreen; margin: 5px;padding: 11px;width: 300px;height: 200px;"></div>'),
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		...
		// previews
		preview: false,
		previewCss: 'max-height:100px; max-width:100px; float:right',
